...
namespace SensorFace
{
    ...
    class DataBase
    {
        ...
        {
            string DataBaseCom = "select Id,Mail,Error,Note from send_mail where UserId=";
            return DataBaseCom;
        }
        public static string GetReceiveMailString()
        {
            string DataBaseCom = "select Id,UserID,Mail,Cycle,Error,Note from receive_mail where UserId=";
            return DataBaseCom;
        }
        public static string InsertNewUserid()
        {
            string DataBaseCom="insert into mail_users (Userid) values ("+")";
            return DataBaseCom;
        }
        ...
        public static string GetIntoCfg(string cfg)
        {
            string DataBaseCom = "INSERT into tp_supperface (cfg) VALUES(\""+cfg+"\")";
            return DataBaseCom;
        }
        public static string GetJoinLoginReg()
        {
            try
            {
