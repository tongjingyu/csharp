...
//  void    WM__InvalidateDrawEx      (const GUI_RECT* pInvalidRect, WM_HWIN hParent, WM_HWIN hStop);
  void    WM__InvalidateDrawAndDescs(WM_HWIN hWin);
#else
//  #define WM__InvalidateDrawEx(pInvalidRect, hParent, hStop) WM__InvalidateRectEx(pInvalidRect, hParent, hStop)
